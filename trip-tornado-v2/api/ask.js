...
module.exports = async function (req, res) {
  ...
  if (!process.env.ANTHROPIC_API_KEY) {
    return res.status(500).json({ error: "ANTHROPIC_API_KEY is not set in Vercel Environment Variables. Go to Vercel → your project → Settings → Environment Variables and add it." });
  }
